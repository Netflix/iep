...
object Dependencies {
  ...
  val equalsVerifier   = "nl.jqno.equalsverifier" % "equalsverifier" % "3.0.3"
  ...
  val rxjava2          = "io.reactivex.rxjava2" % "rxjava" % "2.2.3"
